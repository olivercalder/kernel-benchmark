...
def main(options):
    ...
    dirname = os.path.dirname(os.path.abspath(__file__))
    firecracker_path = "/tmp/firecracker-x86_64" # find_firecracker(dirname, options.arch)
    ...
    try:
        ...
        if options.networking:
            client.add_network_interface('eth0', options.tapname)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--tapname", action="store", type=str, default="fc_tap0",
                        help="name to use for the tap networking")
    parser.add_argument("--createtap", action="store_true",
                        help="try to create tap interface if it does not exist")
    parser.add_argument("--tap_ip", action="store", type=str, default="172.16.0.1",
                        help="name to use for the tap networking")
    parser.add_argument("--client_ip", action="store", type=str, default="172.16.0.2",
                        help="name to use for the tap networking")
