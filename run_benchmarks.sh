...
run_linux() {
    ...
    sh benchmark_linux.sh -o linux-results-r"$1".txt -p linux-output-r"$1" -i qemu_image_timescript.img -n -r "$1" -w 120 -t 60 2> /dev/null
...
run_linux_kvm() {
    ...
    sh benchmark_linux.sh -o linux-kvm-results-r"$1".txt -p linux-kvm-output-r"$1" -i qemu_image_timescript.img -n -r "$1" -w 120 -t 60 -k 2> /dev/null
...
run_rust() {
    ...
    sh benchmark_rust.sh -o rust-results-r"$1".txt -p rust-output-r"$1" -r "$1" -w 120 -t 60 2> /dev/null
...
run_process() {
    ...
    sh benchmark_process.sh -o process-results-r"$1".txt -p process-output-r"$1" -r "$1" -w 120 -t 60 2> /dev/null
